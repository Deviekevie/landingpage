...
class AdminManager {
    ...
    if (!document.getElementById('admin-panel')) {
      ...
      panel.innerHTML = `
        <div id="admin-login-form">
          <h3 style="margin-bottom: 20px; color: #62109F;">Admin Login</h3>
          <form id="adminLoginForm">
            ...
            <button type="submit" style="width: 100%; padding: 10px; background: #62109F; color: white; border: none; border-radius: 5px; cursor: pointer;">
              Login
            </button>
          </form>
        ...
        <div id="admin-dashboard" style="display: none;">
          <h3 style="margin-bottom: 20px; color: #62109F;">Admin Dashboard</h3>
          ...
          <div id="admin-upload-section" style="margin-top: 20px;">
            ...
            <form id="projectUploadForm">
              ...
              <input type="text" id="project-category" placeholder="Category (first/second/third)" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; margin-bottom: 10px;">
  ...
  async handleProjectUpload(e) {
    ...
    try {
      ...
      // Upload image
      const uploadResponse = await window.API.upload.uploadImage(fileInput.files[0]);
      ...
      const projectResponse = await window.API.projects.create({
        ...
        category: categoryInput.value.trim() || 'first'
      });
